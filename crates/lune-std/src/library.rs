    ...
    */
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            #[cfg(feature = "file")]   Self::File   => "file",
    ...
    */
    ...
    pub fn typedefs(&self) -> String {
    	match self {
            ...
            #[cfg(feature = "file")]   Self::File   => lune_std_file::typedefs(),
    ...
    */
    ...
    pub fn module(&self, lua: Lua) -> LuaResult<LuaTable> {
        ...
        let res: LuaResult<LuaTable> = match self {
            ...
            #[cfg(feature = "file")]   Self::File   => lune_std_file::module(mod_lua),
...
impl FromStr for LuneStandardLibrary {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(match low.as_str() {
            ...
            #[cfg(feature = "file")]   "file"   => Self::File,
